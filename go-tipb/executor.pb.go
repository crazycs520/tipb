...
const (
	...
	ExecType_TypeIndexLookUpRoot ExecType = 100
	ExecType_TypeTableReader     ExecType = 101
	ExecType_TypeIndexReader     ExecType = 102
)
...
type Executor struct {
	...
	IndexLookupRoot *IndexLookUp `protobuf:"bytes,100,opt,name=index_lookup_root,json=indexLookupRoot" json:"index_lookup_root,omitempty"`
	TableReader     *TableReader `protobuf:"bytes,101,opt,name=table_reader,json=tableReader" json:"table_reader,omitempty"`
	IndexReader     *IndexReader `protobuf:"bytes,102,opt,name=index_reader,json=indexReader" json:"index_reader,omitempty"`
...
func (m *Executor) GetIndexLookupRoot() *IndexLookUp {
	if m != nil {
		return m.IndexLookupRoot
	}
	return nil
}

func (m *Executor) GetTableReader() *TableReader {
	if m != nil {
		return m.TableReader
	}
	return nil
}

func (m *Executor) GetIndexReader() *IndexReader {
	if m != nil {
		return m.IndexReader
	}
	return nil
}
...
type TableReader struct {
	Child *Executor `protobuf:"bytes,1,opt,name=child" json:"child,omitempty"`
}

func (m *TableReader) Reset()         { *m = TableReader{} }
func (m *TableReader) String() string { return proto.CompactTextString(m) }
func (*TableReader) ProtoMessage()    {}
func (*TableReader) Descriptor() ([]byte, []int) {
	return fileDescriptor_12d1cdcda51e000f, []int{4}
}
func (m *TableReader) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TableReader) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TableReader.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TableReader) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TableReader.Merge(m, src)
}
func (m *TableReader) XXX_Size() int {
	return m.Size()
}
func (m *TableReader) XXX_DiscardUnknown() {
	xxx_messageInfo_TableReader.DiscardUnknown(m)
}

var xxx_messageInfo_TableReader proto.InternalMessageInfo

func (m *TableReader) GetChild() *Executor {
	if m != nil {
		return m.Child
	}
	return nil
...
func (m *IndexReader) Reset()         { *m = IndexReader{} }
func (m *IndexReader) String() string { return proto.CompactTextString(m) }
func (*IndexReader) ProtoMessage()    {}
func (*IndexReader) Descriptor() ([]byte, []int) {
	return fileDescriptor_12d1cdcda51e000f, []int{5}
}
func (m *IndexReader) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IndexReader) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IndexReader.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IndexReader) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IndexReader.Merge(m, src)
}
func (m *IndexReader) XXX_Size() int {
	return m.Size()
}
func (m *IndexReader) XXX_DiscardUnknown() {
	xxx_messageInfo_IndexReader.DiscardUnknown(m)
}

var xxx_messageInfo_IndexReader proto.InternalMessageInfo

func (m *IndexReader) GetChild() *Executor {
	if m != nil {
		return m.Child
	}
	return nil
...
type Join struct {
	...
	Children     []*Executor  `protobuf:"bytes,3,rep,name=children" json:"children,omitempty"`
	// Output column offsets in the full joined schema (left schema + right schema).
	// The Join executor's output schema is defined as these offsets in order.
	OutputOffsets []uint32 `protobuf:"varint,15,rep,name=output_offsets,json=outputOffsets" json:"output_offsets,omitempty"`
...
func (m *Join) GetOutputOffsets() []uint32 {
	if m != nil {
...
type IndexScan struct {
	...
	// encoded KV ranges.
	Ranges []KeyRange `protobuf:"bytes,8,rep,name=ranges" json:"ranges"`
	// same semantics as PhysicalIndexScan.KeepOrder
	KeepOrder *bool `protobuf:"varint,9,opt,name=keep_order,json=keepOrder" json:"keep_order,omitempty"`
}
...
func (m *IndexScan) GetKeepOrder() bool {
	if m != nil && m.KeepOrder != nil {
		return *m.KeepOrder
	}
	return false
...
type RemoteExecutionContext struct {
	...
	SqlMode               uint64 `protobuf:"varint,2,opt,name=sql_mode,json=sqlMode" json:"sql_mode"`
	TimeZoneName          string `protobuf:"bytes,3,opt,name=time_zone_name,json=timeZoneName" json:"time_zone_name"`
	TimeZoneOffset        int64  `protobuf:"varint,4,opt,name=time_zone_offset,json=timeZoneOffset" json:"time_zone_offset"`
	Collation             int32  `protobuf:"varint,5,opt,name=collation" json:"collation"`
	StmtFlags             uint32 `protobuf:"varint,6,opt,name=stmt_flags,json=stmtFlags" json:"stmt_flags"`
	LockWaitTimeoutMs     uint64 `protobuf:"varint,7,opt,name=lock_wait_timeout_ms,json=lockWaitTimeoutMs" json:"lock_wait_timeout_ms"`
	MaxWarningCount       uint64 `protobuf:"varint,8,opt,name=max_warning_count,json=maxWarningCount" json:"max_warning_count"`
	DivPrecisionIncrement uint32 `protobuf:"varint,9,opt,name=div_precision_increment,json=divPrecisionIncrement" json:"div_precision_increment"`
	Flags                 uint64 `protobuf:"varint,10,opt,name=flags" json:"flags"`
}

func (m *RemoteExecutionContext) Reset()         { *m = RemoteExecutionContext{} }
func (m *RemoteExecutionContext) String() string { return proto.CompactTextString(m) }
func (*RemoteExecutionContext) ProtoMessage()    {}
func (*RemoteExecutionContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_12d1cdcda51e000f, []int{40}
}
func (m *RemoteExecutionContext) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemoteExecutionContext) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemoteExecutionContext.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemoteExecutionContext) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoteExecutionContext.Merge(m, src)
}
func (m *RemoteExecutionContext) XXX_Size() int {
	return m.Size()
}
func (m *RemoteExecutionContext) XXX_DiscardUnknown() {
	xxx_messageInfo_RemoteExecutionContext.DiscardUnknown(m)
}

var xxx_messageInfo_RemoteExecutionContext proto.InternalMessageInfo

func (m *RemoteExecutionContext) GetConnectionId() uint64 {
	if m != nil {
...
func (m *RemoteExecutionContext) GetSqlMode() uint64 {
	if m != nil {
		return m.SqlMode
	}
	return 0
...
func (m *RemoteExecutionContext) GetTimeZoneName() string {
	if m != nil {
...
func (m *RemoteExecutionContext) GetTimeZoneOffset() int64 {
	if m != nil {
...
func (m *RemoteExecutionContext) GetCollation() int32 {
	if m != nil {
		return m.Collation
	}
	return 0
...
func (m *RemoteExecutionContext) GetStmtFlags() uint32 {
	if m != nil {
		return m.StmtFlags
	}
	return 0
...
func (m *RemoteExecutionContext) GetLockWaitTimeoutMs() uint64 {
	if m != nil {
		return m.LockWaitTimeoutMs
	}
	return 0
}

func (m *RemoteExecutionContext) GetMaxWarningCount() uint64 {
	if m != nil {
...
func (m *RemoteExecutionContext) GetDivPrecisionIncrement() uint32 {
	if m != nil {
...
func (m *RemoteExecutionContext) GetFlags() uint64 {
	if m != nil {
		return m.Flags
	}
	return 0
...
type RemoteExecutorRequest struct {
	// Encoded kvrpcpb.Context.
	Context []byte `protobuf:"bytes,1,opt,name=context" json:"context,omitempty"`
	// Encoded DAGRequest (tipb.DAGRequest, list-based executors).
	Plan   []byte     `protobuf:"bytes,2,opt,name=plan" json:"plan,omitempty"`
	Ranges []KeyRange `protobuf:"bytes,3,rep,name=ranges" json:"ranges"`
	// Probe-side ranges (HashJoinRoot only).
	OuterRanges   []KeyRange   `protobuf:"bytes,13,rep,name=outer_ranges,json=outerRanges" json:"outer_ranges"`
	StartTs       uint64       `protobuf:"varint,4,opt,name=start_ts,json=startTs" json:"start_ts"`
	SchemaVer     int64        `protobuf:"varint,5,opt,name=schema_ver,json=schemaVer" json:"schema_ver"`
	Limit         uint64       `protobuf:"varint,6,opt,name=limit" json:"limit"`
	OutputOffsets []uint32     `protobuf:"varint,7,rep,name=output_offsets,json=outputOffsets" json:"output_offsets,omitempty"`
	OutputTypes   []*FieldType `protobuf:"bytes,8,rep,name=output_types,json=outputTypes" json:"output_types,omitempty"`
	// When the root executor is Projection, this field stores the child output schema types,
	// so the remote side can evaluate projection expressions with correct input types.
	ProjectionInputTypes []*FieldType `protobuf:"bytes,14,rep,name=projection_input_types,json=projectionInputTypes" json:"projection_input_types,omitempty"`
	// When the root executor is Projection, this field stores the mapping from
	// projection_input_types (in order) to the child plan output schema offsets.
	// For HashJoin child, offsets are based on full joined schema (left schema + right schema).
	// For non-HashJoin child, offsets must be 0..N-1 (identity mapping).
	ProjectionInputOffsets []uint32                `protobuf:"varint,15,rep,name=projection_input_offsets,json=projectionInputOffsets" json:"projection_input_offsets,omitempty"`
	KeepOrder              bool                    `protobuf:"varint,9,opt,name=keep_order,json=keepOrder" json:"keep_order"`
	ChunkSize              uint32                  `protobuf:"varint,10,opt,name=chunk_size,json=chunkSize" json:"chunk_size"`
	TimeoutMs              uint64                  `protobuf:"varint,11,opt,name=timeout_ms,json=timeoutMs" json:"timeout_ms"`
	SessionCtx             *RemoteExecutionContext `protobuf:"bytes,12,opt,name=session_ctx,json=sessionCtx" json:"session_ctx,omitempty"`
}

func (m *RemoteExecutorRequest) Reset()         { *m = RemoteExecutorRequest{} }
func (m *RemoteExecutorRequest) String() string { return proto.CompactTextString(m) }
func (*RemoteExecutorRequest) ProtoMessage()    {}
func (*RemoteExecutorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_12d1cdcda51e000f, []int{41}
}
func (m *RemoteExecutorRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemoteExecutorRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemoteExecutorRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemoteExecutorRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoteExecutorRequest.Merge(m, src)
}
func (m *RemoteExecutorRequest) XXX_Size() int {
	return m.Size()
}
func (m *RemoteExecutorRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RemoteExecutorRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RemoteExecutorRequest proto.InternalMessageInfo

func (m *RemoteExecutorRequest) GetContext() []byte {
	if m != nil {
		return m.Context
	}
	return nil
...
func (m *RemoteExecutorRequest) GetPlan() []byte {
	if m != nil {
		return m.Plan
	}
	return nil
...
func (m *RemoteExecutorRequest) GetRanges() []KeyRange {
	if m != nil {
		return m.Ranges
	}
	return nil
...
func (m *RemoteExecutorRequest) GetOuterRanges() []KeyRange {
	if m != nil {
		return m.OuterRanges
	}
	return nil
}

func (m *RemoteExecutorRequest) GetStartTs() uint64 {
	if m != nil {
		return m.StartTs
	}
	return 0
...
func (m *RemoteExecutorRequest) GetSchemaVer() int64 {
	if m != nil {
		return m.SchemaVer
	}
	return 0
...
func (m *RemoteExecutorRequest) GetLimit() uint64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *RemoteExecutorRequest) GetOutputOffsets() []uint32 {
	if m != nil {
		return m.OutputOffsets
	}
	return nil
...
func (m *RemoteExecutorRequest) GetOutputTypes() []*FieldType {
	if m != nil {
...
func (m *RemoteExecutorRequest) GetProjectionInputTypes() []*FieldType {
	if m != nil {
		return m.ProjectionInputTypes
	}
	return nil
}

func (m *RemoteExecutorRequest) GetProjectionInputOffsets() []uint32 {
	if m != nil {
		return m.ProjectionInputOffsets
	}
	return nil
}

func (m *RemoteExecutorRequest) GetKeepOrder() bool {
	if m != nil {
		return m.KeepOrder
	}
	return false
...
func (m *RemoteExecutorRequest) GetChunkSize() uint32 {
	if m != nil {
		return m.ChunkSize
	}
	return 0
...
func (m *RemoteExecutorRequest) GetTimeoutMs() uint64 {
	if m != nil {
		return m.TimeoutMs
	}
	return 0
...
func (m *RemoteExecutorRequest) GetSessionCtx() *RemoteExecutionContext {
	if m != nil {
		return m.SessionCtx
	}
	return nil
...
type RemoteExecutorResponse struct {
	// Encoded SelectResponse.
	Data []byte `protobuf:"bytes,1,opt,name=data" json:"data,omitempty"`
	// Encoded errorpb.Error.
	RegionError []byte `protobuf:"bytes,2,opt,name=region_error,json=regionError" json:"region_error,omitempty"`
	// Encoded kvrpcpb.LockInfo.
	Locked     []byte `protobuf:"bytes,3,opt,name=locked" json:"locked,omitempty"`
	OtherError string `protobuf:"bytes,4,opt,name=other_error,json=otherError" json:"other_error"`
	// Encoded kvrpcpb.ExecDetailsV2.
	ExecDetailsV2 []byte `protobuf:"bytes,5,opt,name=exec_details_v2,json=execDetailsV2" json:"exec_details_v2,omitempty"`
	// Encoded kvrpcpb.Warning list, each element is a single Warning message.
	Warnings [][]byte `protobuf:"bytes,6,rep,name=warnings" json:"warnings,omitempty"`
}

func (m *RemoteExecutorResponse) Reset()         { *m = RemoteExecutorResponse{} }
func (m *RemoteExecutorResponse) String() string { return proto.CompactTextString(m) }
func (*RemoteExecutorResponse) ProtoMessage()    {}
func (*RemoteExecutorResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_12d1cdcda51e000f, []int{42}
}
func (m *RemoteExecutorResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemoteExecutorResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemoteExecutorResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemoteExecutorResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoteExecutorResponse.Merge(m, src)
}
func (m *RemoteExecutorResponse) XXX_Size() int {
	return m.Size()
}
func (m *RemoteExecutorResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RemoteExecutorResponse.DiscardUnknown(m)
}

var xxx_messageInfo_RemoteExecutorResponse proto.InternalMessageInfo

func (m *RemoteExecutorResponse) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *RemoteExecutorResponse) GetRegionError() []byte {
	if m != nil {
...
func (m *RemoteExecutorResponse) GetLocked() []byte {
	if m != nil {
		return m.Locked
	}
	return nil
...
func (m *RemoteExecutorResponse) GetOtherError() string {
	if m != nil {
		return m.OtherError
	}
	return ""
...
func (m *RemoteExecutorResponse) GetExecDetailsV2() []byte {
	if m != nil {
...
func (m *RemoteExecutorResponse) GetWarnings() [][]byte {
	if m != nil {
		return m.Warnings
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TableReader)(nil), "tipb.TableReader")
	proto.RegisterType((*IndexReader)(nil), "tipb.IndexReader")
	...
	proto.RegisterType((*RemoteExecutionContext)(nil), "tipb.RemoteExecutionContext")
	proto.RegisterType((*RemoteExecutorRequest)(nil), "tipb.RemoteExecutorRequest")
	proto.RegisterType((*RemoteExecutorResponse)(nil), "tipb.RemoteExecutorResponse")
}
...
var fileDescriptor_12d1cdcda51e000f = []byte{
	...
	,
}
...
func (m *Executor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.IndexLookupRoot != nil {
		{
			size, err := m.IndexLookupRoot.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TableReader) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TableReader) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TableReader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IndexReader) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IndexReader) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IndexReader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Join) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OutputOffsets) > 0 {
		for iNdEx := len(m.OutputOffsets) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintExecutor(dAtA, i, uint64(m.OutputOffsets[iNdEx]))
			i--
			dAtA[i] = 0x78
		}
	}
...
func (m *RemoteExecutionContext) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemoteExecutionContext) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoteExecutionContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	i = encodeVarintExecutor(dAtA, i, uint64(m.Flags))
	i--
	dAtA[i] = 0x50
	i = encodeVarintExecutor(dAtA, i, uint64(m.DivPrecisionIncrement))
	i--
	dAtA[i] = 0x48
	i = encodeVarintExecutor(dAtA, i, uint64(m.MaxWarningCount))
	i--
	dAtA[i] = 0x40
	i = encodeVarintExecutor(dAtA, i, uint64(m.LockWaitTimeoutMs))
	i--
	dAtA[i] = 0x38
	i = encodeVarintExecutor(dAtA, i, uint64(m.StmtFlags))
	i--
	dAtA[i] = 0x30
	i = encodeVarintExecutor(dAtA, i, uint64(m.Collation))
	i--
	dAtA[i] = 0x28
	i = encodeVarintExecutor(dAtA, i, uint64(m.TimeZoneOffset))
	i--
	dAtA[i] = 0x20
	i -= len(m.TimeZoneName)
	copy(dAtA[i:], m.TimeZoneName)
	i = encodeVarintExecutor(dAtA, i, uint64(len(m.TimeZoneName)))
	i--
	dAtA[i] = 0x1a
	i = encodeVarintExecutor(dAtA, i, uint64(m.SqlMode))
	i--
	dAtA[i] = 0x10
...
func (m *RemoteExecutorRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemoteExecutorRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoteExecutorRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ProjectionInputOffsets) > 0 {
		for iNdEx := len(m.ProjectionInputOffsets) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintExecutor(dAtA, i, uint64(m.ProjectionInputOffsets[iNdEx]))
			i--
			dAtA[i] = 0x78
		}
	}
	if len(m.ProjectionInputTypes) > 0 {
		for iNdEx := len(m.ProjectionInputTypes) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ProjectionInputTypes[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.OuterRanges) > 0 {
		for iNdEx := len(m.OuterRanges) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OuterRanges[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.SessionCtx != nil {
		{
			size, err := m.SessionCtx.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	i = encodeVarintExecutor(dAtA, i, uint64(m.TimeoutMs))
	i--
	dAtA[i] = 0x58
	i = encodeVarintExecutor(dAtA, i, uint64(m.ChunkSize))
	i--
	dAtA[i] = 0x50
	i--
	if m.KeepOrder {
	...
	if len(m.OutputTypes) > 0 {
		for iNdEx := len(m.OutputTypes) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OutputTypes[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	i--
	dAtA[i] = 0x30
	i = encodeVarintExecutor(dAtA, i, uint64(m.SchemaVer))
	i--
	dAtA[i] = 0x28
	i = encodeVarintExecutor(dAtA, i, uint64(m.StartTs))
	i--
	dAtA[i] = 0x20
	if len(m.Ranges) > 0 {
		for iNdEx := len(m.Ranges) - 1; iNdEx >= 0; iNdEx-- {
	...
	if m.Plan != nil {
		i -= len(m.Plan)
		copy(dAtA[i:], m.Plan)
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.Plan)))
		i--
		dAtA[i] = 0x12
	}
	if m.Context != nil {
		...
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.Context)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RemoteExecutorResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemoteExecutorResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoteExecutorResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Warnings) > 0 {
		for iNdEx := len(m.Warnings) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintExecutor(dAtA, i, uint64(len(m.Warnings[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
	if m.ExecDetailsV2 != nil {
		i -= len(m.ExecDetailsV2)
		copy(dAtA[i:], m.ExecDetailsV2)
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.ExecDetailsV2)))
		i--
		dAtA[i] = 0x2a
	}
	i -= len(m.OtherError)
	copy(dAtA[i:], m.OtherError)
	i = encodeVarintExecutor(dAtA, i, uint64(len(m.OtherError)))
	i--
	dAtA[i] = 0x22
	if m.Locked != nil {
		i -= len(m.Locked)
		copy(dAtA[i:], m.Locked)
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.Locked)))
		i--
		dAtA[i] = 0x1a
	}
	if m.RegionError != nil {
		i -= len(m.RegionError)
		copy(dAtA[i:], m.RegionError)
		i = encodeVarintExecutor(dAtA, i, uint64(len(m.RegionError)))
		i--
		dAtA[i] = 0x12
	}
	if m.Data != nil {
...
func (m *RemoteExecutionContext) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + sovExecutor(uint64(m.SqlMode))
	l = len(m.TimeZoneName)
	n += 1 + l + sovExecutor(uint64(l))
	n += 1 + sovExecutor(uint64(m.TimeZoneOffset))
	n += 1 + sovExecutor(uint64(m.Collation))
	n += 1 + sovExecutor(uint64(m.StmtFlags))
	n += 1 + sovExecutor(uint64(m.LockWaitTimeoutMs))
	n += 1 + sovExecutor(uint64(m.MaxWarningCount))
	n += 1 + sovExecutor(uint64(m.DivPrecisionIncrement))
	n += 1 + sovExecutor(uint64(m.Flags))
	return n
}

func (m *RemoteExecutorRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + sovExecutor(uint64(m.StartTs))
	n += 1 + sovExecutor(uint64(m.SchemaVer))
	n += 1 + sovExecutor(uint64(m.Limit))
	if len(m.OutputOffsets) > 0 {
		for _, e := range m.OutputOffsets {
			n += 1 + sovExecutor(uint64(e))
	...
	if len(m.OutputTypes) > 0 {
		for _, e := range m.OutputTypes {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
	n += 2
	n += 1 + sovExecutor(uint64(m.ChunkSize))
	n += 1 + sovExecutor(uint64(m.TimeoutMs))
	if m.SessionCtx != nil {
		l = m.SessionCtx.Size()
		n += 1 + l + sovExecutor(uint64(l))
	}
	if len(m.OuterRanges) > 0 {
		for _, e := range m.OuterRanges {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
	if len(m.ProjectionInputTypes) > 0 {
		for _, e := range m.ProjectionInputTypes {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
	if len(m.ProjectionInputOffsets) > 0 {
		for _, e := range m.ProjectionInputOffsets {
			n += 1 + sovExecutor(uint64(e))
		}
	}
	return n
...
func (m *RemoteExecutorResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + l + sovExecutor(uint64(l))
	if m.ExecDetailsV2 != nil {
		l = len(m.ExecDetailsV2)
		n += 1 + l + sovExecutor(uint64(l))
	}
	if len(m.Warnings) > 0 {
		for _, b := range m.Warnings {
			l = len(b)
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *Executor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 100:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexLookupRoot", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IndexLookupRoot == nil {
				m.IndexLookupRoot = &IndexLookUp{}
			}
			if err := m.IndexLookupRoot.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 101:
...
func (m *TableReader) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TableReader: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TableReader: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *IndexReader) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IndexReader: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IndexReader: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RemoteExecutionContext) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemoteExecutionContext: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemoteExecutionContext: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StmtFlags", wireType)
			}
			m.StmtFlags = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StmtFlags |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockWaitTimeoutMs", wireType)
			}
			m.LockWaitTimeoutMs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExecutor
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LockWaitTimeoutMs |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *RemoteExecutorRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemoteExecutorRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemoteExecutorRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutputTypes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OutputTypes = append(m.OutputTypes, &FieldType{})
			if err := m.OutputTypes[len(m.OutputTypes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SessionCtx", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SessionCtx == nil {
				m.SessionCtx = &RemoteExecutionContext{}
			}
			if err := m.SessionCtx.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OuterRanges", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OuterRanges = append(m.OuterRanges, KeyRange{})
			if err := m.OuterRanges[len(m.OuterRanges)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProjectionInputTypes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProjectionInputTypes = append(m.ProjectionInputTypes, &FieldType{})
			if err := m.ProjectionInputTypes[len(m.ProjectionInputTypes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 15:
			if wireType == 0 {
				...
				m.ProjectionInputOffsets = append(m.ProjectionInputOffsets, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.ProjectionInputOffsets) == 0 {
					m.ProjectionInputOffsets = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field ProjectionInputOffsets", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipExecutor(dAtA[iNdEx:])
...
func (m *RemoteExecutorResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemoteExecutorResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemoteExecutorResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.RegionError = append(m.RegionError[:0], dAtA[iNdEx:postIndex]...)
			if m.RegionError == nil {
				m.RegionError = []byte{}
			}
			iNdEx = postIndex
		...
		case 5:
			...
			m.ExecDetailsV2 = append(m.ExecDetailsV2[:0], dAtA[iNdEx:postIndex]...)
			if m.ExecDetailsV2 == nil {
				m.ExecDetailsV2 = []byte{}
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
			...
			m.Warnings = append(m.Warnings, make([]byte, postIndex-iNdEx))
			copy(m.Warnings[len(m.Warnings)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipExecutor(dAtA[iNdEx:])
