...
type DAGRequest struct {
	...
	ExtraTableId          *int64      `protobuf:"varint,20,opt,name=extra_table_id,json=extraTableId" json:"extra_table_id,omitempty"`
...
func (m *DAGRequest) GetExtraTableId() int64 {
	if m != nil && m.ExtraTableId != nil {
		return *m.ExtraTableId
	}
	return 0
}
...
func (m *DAGRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExtraTableId != nil {
		dAtA[i] = 0xa0
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.ExtraTableId))
	}
...
func (m *DAGRequest) Size() (n int) {
	...
	if m.ExtraTableId != nil {
		n += 2 + sovSelect(uint64(*m.ExtraTableId))
	}
	if len(m.ExtraExecutors) > 0 {
...
func (m *DAGRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraTableId", wireType)
			}
			var v int64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorSelect = []byte{
	...
	,
}
