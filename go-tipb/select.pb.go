...
type SelectResponse struct {
	...
	ExtraChunks []*Chunk `protobuf:"bytes,11,rep,name=extra_chunks,json=extraChunks" json:"extra_chunks,omitempty"`
}
...
func (m *SelectResponse) GetExtraChunks() []*Chunk {
	if m != nil {
		return m.ExtraChunks
	}
	return nil
}
...
type DAGRequest struct {
	...
	ExtraExecutors        []*Executor `protobuf:"bytes,20,rep,name=extra_executors,json=extraExecutors" json:"extra_executors,omitempty"`
	ExtraOutputOffsets    []uint32    `protobuf:"varint,21,rep,name=extra_output_offsets,json=extraOutputOffsets" json:"extra_output_offsets,omitempty"`
	ExtraKeepOrder        *bool       `protobuf:"varint,22,opt,name=extra_keep_order,json=extraKeepOrder" json:"extra_keep_order,omitempty"`
}
...
func (m *DAGRequest) GetExtraExecutors() []*Executor {
	if m != nil {
		return m.ExtraExecutors
	}
	return nil
}

func (m *DAGRequest) GetExtraOutputOffsets() []uint32 {
	if m != nil {
		return m.ExtraOutputOffsets
	}
	return nil
}

func (m *DAGRequest) GetExtraKeepOrder() bool {
	if m != nil && m.ExtraKeepOrder != nil {
		return *m.ExtraKeepOrder
	}
	return false
}
...
var fileDescriptor_86353caa10f8b4d7 = []byte{
	...
	,
}
...
func (m *SelectResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ExtraChunks) > 0 {
		for iNdEx := len(m.ExtraChunks) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExtraChunks[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DAGRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExtraOutputOffsets) > 0 {
		for iNdEx := len(m.ExtraOutputOffsets) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintSelect(dAtA, i, uint64(m.ExtraOutputOffsets[iNdEx]))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xa8
	...
	if len(m.ExtraExecutors) > 0 {
		for iNdEx := len(m.ExtraExecutors) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExtraExecutors[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DAGRequest) Size() (n int) {
	...
	if len(m.ExtraExecutors) > 0 {
		for _, e := range m.ExtraExecutors {
			l = e.Size()
			n += 2 + l + sovSelect(uint64(l))
		}
	}
	if len(m.ExtraOutputOffsets) > 0 {
		for _, e := range m.ExtraOutputOffsets {
			n += 2 + sovSelect(uint64(e))
		}
	}
	if m.ExtraKeepOrder != nil {
		n += 3
...
func (m *SelectResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraChunks", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExtraChunks = append(m.ExtraChunks, &Chunk{})
			if err := m.ExtraChunks[len(m.ExtraChunks)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DAGRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraExecutors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExtraExecutors = append(m.ExtraExecutors, &Executor{})
			if err := m.ExtraExecutors[len(m.ExtraExecutors)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 21:
			if wireType == 0 {
				...
				m.ExtraOutputOffsets = append(m.ExtraOutputOffsets, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.ExtraOutputOffsets) == 0 {
					m.ExtraOutputOffsets = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraOutputOffsets", wireType)
			}
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraKeepOrder", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
