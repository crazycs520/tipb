...
type DAGRequest struct {
	...
	IndexLookup      *bool      `protobuf:"varint,19,opt,name=index_lookup,json=indexLookup" json:"index_lookup,omitempty"`
	TableInfo        *TableInfo `protobuf:"bytes,20,opt,name=table_info,json=tableInfo" json:"table_info,omitempty"`
	XXX_unrecognized []byte     `json:"-"`
}
...
func (m *DAGRequest) GetIndexLookup() bool {
...
func (m *DAGRequest) GetTableInfo() *TableInfo {
	if m != nil {
		return m.TableInfo
	}
	return nil
...
func (m *DAGRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TableInfo != nil {
		...
		n6, err := m.TableInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
var fileDescriptorSelect = []byte{
	...
	,
}
