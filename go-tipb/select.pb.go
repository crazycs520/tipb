...
type DAGRequest struct {
	...
	ExtraTableInfo        *TableScan  `protobuf:"bytes,20,opt,name=extra_table_info,json=extraTableInfo" json:"extra_table_info,omitempty"`
	ExtraExecutors        []*Executor `protobuf:"bytes,21,rep,name=extra_executors,json=extraExecutors" json:"extra_executors,omitempty"`
	ExtraOutputOffsets    []uint32    `protobuf:"varint,22,rep,name=extra_output_offsets,json=extraOutputOffsets" json:"extra_output_offsets,omitempty"`
	XXX_unrecognized      []byte      `json:"-"`
}
...
func (m *DAGRequest) GetExtraTableInfo() *TableScan {
	if m != nil {
		return m.ExtraTableInfo
	}
	return nil
}
...
func (m *DAGRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExtraTableInfo != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintSelect(dAtA, i, uint64(m.ExtraTableInfo.Size()))
		n6, err := m.ExtraTableInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
	...
	if len(m.ExtraExecutors) > 0 {
		for _, msg := range m.ExtraExecutors {
			dAtA[i] = 0xaa
			i++
			dAtA[i] = 0x1
			i++
	...
	if len(m.ExtraOutputOffsets) > 0 {
		for _, num := range m.ExtraOutputOffsets {
			dAtA[i] = 0xb0
			i++
			dAtA[i] = 0x1
			i++
...
func (m *DAGRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExtraTableInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ExtraTableInfo == nil {
				m.ExtraTableInfo = &TableScan{}
			}
			if err := m.ExtraTableInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 21:
...
var fileDescriptorSelect = []byte{
	...
	,
}
