...
type ResourceGroupKeyLabel int32

const (
	ResourceGroupKeyLabel_IsOthers ResourceGroupKeyLabel = 0
	ResourceGroupKeyLabel_IsIndex  ResourceGroupKeyLabel = 1
	ResourceGroupKeyLabel_IsRow    ResourceGroupKeyLabel = 2
)

var ResourceGroupKeyLabel_name = map[int32]string{
	0: "IsOthers",
	1: "IsIndex",
	2: "IsRow",
}
var ResourceGroupKeyLabel_value = map[string]int32{
	"IsOthers": 0,
	"IsIndex":  1,
	"IsRow":    2,
}

func (x ResourceGroupKeyLabel) Enum() *ResourceGroupKeyLabel {
	p := new(ResourceGroupKeyLabel)
	*p = x
	return p
}
func (x ResourceGroupKeyLabel) String() string {
	return proto.EnumName(ResourceGroupKeyLabel_name, int32(x))
}
func (x *ResourceGroupKeyLabel) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ResourceGroupKeyLabel_value, data, "ResourceGroupKeyLabel")
	if err != nil {
		return err
	}
	*x = ResourceGroupKeyLabel(value)
	return nil
}
func (ResourceGroupKeyLabel) EnumDescriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterEnum("tipb.ResourceGroupKeyLabel", ResourceGroupKeyLabel_name, ResourceGroupKeyLabel_value)
}
...
var fileDescriptorResourcetag = []byte{
	...
	0x4e, 0x62, 0x1e, 0x4c, 0x9e, 0x09, 0x2c, 0xcf, 0x05, 0x12, 0x82, 0x28, 0xd0, 0xb2, 0xe5, 0x12,
	0x45, 0x31, 0xd3, 0x3b, 0xb5, 0xd2, 0x27, 0x31, 0x29, 0x35, 0x47, 0x88, 0x87, 0x8b, 0xc3, 0xb3,
	0xd8, 0xbf, 0x24, 0x23, 0xb5, 0xa8, 0x58, 0x80, 0x41, 0x88, 0x9b, 0x8b, 0xdd, 0xb3, 0xd8, 0x33,
	0x2f, 0x25, 0xb5, 0x42, 0x80, 0x51, 0x88, 0x93, 0x8b, 0xd5, 0xb3, 0x38, 0x28, 0xbf, 0x5c, 0x80,
	0xc9, 0x49, 0xf3, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c,
	0xf1, 0x58, 0x8e, 0x81, 0x4b, 0x34, 0x39, 0x3f, 0x57, 0xaf, 0x20, 0x33, 0x2f, 0x3d, 0x39, 0xb1,
	0x40, 0xaf, 0x24, 0x33, 0x25, 0x49, 0x0f, 0xe4, 0xa3, 0x00, 0x46, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x0b, 0xe9, 0x14, 0x60, 0xed, 0x00, 0x00, 0x00,
}
